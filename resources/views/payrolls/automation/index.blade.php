                                    ...
                                    <div class="py-6 px-8 h-full flex flex-col">
                                        ...
                                        <div class="flex items-center justify-between mb-4">
                                            ...
                                            <span class="px-3 py-1 text-xs font-medium rounded-full
                                                {{ $type === 'weekly' ? 'bg-green-100 text-green-800' : '' }}
                                                {{ $type === 'semi_monthly' ? 'bg-blue-100 text-blue-800' : '' }}
                                                {{ $type === 'monthly' ? 'bg-purple-100 text-purple-800' : '' }}">
                                        ...
                                        <div class="mb-4">
                                            <div class="flex items-center text-sm text-gray-600 mb-2">
                                                ...
                                                Active Schedules:
                                                <span class="font-medium ml-1">{{ $scheduleCount }}</span>
                                            </div>
                                            ...
                                            <div class="flex items-center text-sm text-gray-600">
                                                ...
                                                Total Employees:
                                                <span class="font-medium ml-1">{{ $totalEmployees }}</span>
                                            </div>
                                        </div>

                                        <!-- Information Box -->
                                        <div class="bg-gray-50 rounded-md p-3 mb-4 flex-grow">
                                            <h5 class="text-sm font-medium text-gray-900 mb-2">Frequency Overview</h5>
                                            <div class="text-sm text-gray-600">
                                                <div class="mb-1">{{ $scheduleCount }} {{ strtolower($frequencyLabels[$type]) }}</div>
                                                <div>covering {{ $totalEmployees }} employee{{ $totalEmployees > 1 ? 's' : '' }}</div>
                                            </div>
                                        </div>

                                        <!-- Action Button -->
                                        <div class="text-center">
                                            <div class="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-600 bg-blue-100 rounded-md hover:bg-blue-200 transition-colors duration-200">
                                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
